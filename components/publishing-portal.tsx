...
type SubmittedPaper={id:string;title:string;type:string;topic:string;abstract:string;manuscript:string;status:string};
...
export function PublishingPortal(){
  ...
  async function submitWork(event:React.FormEvent<HTMLFormElement>){
    ...
    const paper={title:String(fields.get('title')||''),type:String(fields.get('type')||''),topic:String(fields.get('topic')||''),abstract:String(fields.get('abstract')||''),manuscript:String(fields.get('manuscript')||'')};
    try{
